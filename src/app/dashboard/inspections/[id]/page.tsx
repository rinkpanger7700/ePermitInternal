      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 items-stretch">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 flex flex-col">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="mt-auto pt-2 space-y-2">
              <button onClick={() => router.push(`/dashboard/approvals/${encodeURIComponent(app.reference_no)}`)} className="w-full bg-[#0033A0] hover:bg-blue-800 text-white text-xs font-semibold py-2 rounded transition-colors">
                Route to Next Step
              </button>
